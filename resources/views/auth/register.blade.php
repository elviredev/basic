              ...
              <div class="pt-0">
                <form method="POST" action="{{ route('register') }}" class="my-4">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input class="form-control" type="password" id="password_confirmation" name="password_confirmation"  placeholder="Enter your password">
                ...
                <div class="text-center text-muted mb-4 saprator">
                  <p class="mb-0">Already registered?<a class='text-primary ms-2 fw-medium' href='{{ route('login') }}'>Sign In</a></p>
                </div>

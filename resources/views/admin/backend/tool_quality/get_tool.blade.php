                      ...
                      <div class="card border mb-0">
                        ...
                        <div class="card-header">
                          <div class="row align-items-center">
                            <div class="col">
                              <h4 class="card-title mb-0">Edit Tool Section</h4>
                            </div><!--end col-->
                          </div>
                        </div>

                        <!--Form -->
                        <form action="{{ route('update.tool') }}" method="POST" enctype="multipart/form-data">
                          @csrf
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group mb-3 row">
                              ...
                              <div class="col-lg-12 col-xl-12">
                                <input class="form-control" type="text" name="title" value="{{ $tool->title }}" >
                              </div>
                            </div>
                            ...
                            <div class="form-group mb-3 row">
                              <label class="form-label">Tool Photo</label>
                              <div class="col-lg-12 col-xl-12">
